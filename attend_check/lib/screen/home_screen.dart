...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static final Circle checkedDoneCircle = Circle(
    circleId: const CircleId('checkedDoneCircle'),
    center: companyLatLng,
                ...
                return Column(
                  children: [
                    ...
                    _AttendButton(
                      ...
                      onPressed: onAttendCheckPressed,
                      attendCheckDone: attendCheckDone,
                    ),
                  ],
                );
              },
...
class _AttendButton extends StatelessWidget {
  ...
  final bool attendCheckDone;

  const _AttendButton({
    required this.isWithinRange,
    required this.onPressed,
    required this.attendCheckDone,
    Key? key,
  }) : super(key: key);
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          if (!attendCheckDone && isWithinRange)
            TextButton(
              onPressed: onPressed,
              child: const Text(
                '출근하기',
